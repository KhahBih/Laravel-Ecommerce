<?php $popularCategorySection = json_decode($popularCategorySection->value) ?>
            ...
            <form action="{{route('admin.popular-category-section')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php $subCategories = \App\Models\SubCategory::where('category_id', $popularCategorySection[0]->category)->get(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php $childCategories = \App\Models\ChildCategory::where('sub_category_id', $popularCategorySection[0]->sub_category)->get(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Sub Category</label>
                            <?php $subCategories = \App\Models\SubCategory::where('category_id', $popularCategorySection[1]->category)->get(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Child Category</label>
                            <?php $childCategories = \App\Models\ChildCategory::where('sub_category_id', $popularCategorySection[1]->sub_category)->get(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Sub Category</label>
                            <?php $subCategories = \App\Models\SubCategory::where('category_id', $popularCategorySection[2]->category)->get(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Child Category</label>
                            <?php $childCategories = \App\Models\ChildCategory::where('sub_category_id', $popularCategorySection[2]->sub_category)->get(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Sub Category</label>
                            <?php $subCategories = \App\Models\SubCategory::where('category_id', $popularCategorySection[3]->category)->get(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Child Category</label>
                            <?php $childCategories = \App\Models\ChildCategory::where('sub_category_id', $popularCategorySection[3]->sub_category)->get(); ?>
