                        ...
                        <div class="form-group">
                            ...
                            <select name="cat_one" id="" class="form-control main-category">
                                ...
                                @foreach ($categories as $category)
                                    <option {{$sectionThreeProduct->category == $category->id ? 'selected' : ''}}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_cat_one" id="" class="form-control sub-category">
                                <option value="">Select</option>
                                <?php $subCategories = \App\Models\SubCategory::where('category_id', $sectionThreeProduct->category)->get() ?>
                                @foreach ($subCategories as $subCategory)
                                    <option {{$sectionThreeProduct->sub_category == $subCategory->id ? 'selected' : ''}}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_cat_one" id="" class="form-control child-category">
                                <option value="">Select</option>
                                <?php $childCategories = \App\Models\ChildCategory::where('sub_category_id', $sectionThreeProduct->sub_category)->get() ?>
                                @foreach ($childCategories as $childCategory)
                                    <option {{$sectionThreeProduct->child_category == $childCategory->id ? 'selected' : ''}}
