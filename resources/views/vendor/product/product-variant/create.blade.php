            ...
            <div class="wsus__dashboard_profile">
              <div class="wsus__dash_pro_area">
                <form action="{{route('vendor.products-variant.store')}}" method="POST">
                    ...
                    <div class="form-group wsus_input">
                        <input type="hidden" class="form-control" data-tribute="true" name="product" value="{{request()->product}}">
                    </div>
                    <div class="form-group wsus_input">
                    ...
                    <button type="submit" class="btn btn-primary" style="margin: 10px 0 0 0">Create</button>
                </form>
            </div>
          </div>
        </div>
