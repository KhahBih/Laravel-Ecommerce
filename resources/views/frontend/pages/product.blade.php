...
@section('title'){{$settings->site_name}} @endsection
@section('content')
    <section id="wsus__product_page">
        <div class="container">
            <div class="row">
                <div class="col-xl-12" style="margin: 0 0 20px 0">
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            @foreach ($brands as $item)
                                                <li><a href="{{route('products', ['brand' => $item->slug])}}">{{$item->name}}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="wsus__product_topbar">
                                <div class="wsus__product_topbar_left">
                                    <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link {{session()->has('product_list_style') && session()->get('product_list_style') == 'grid' ? 'active' : ''}}
                                            {{!session()->has('product_list_style') ? 'active' : ''}} list-view"
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="wsus__product_item">
                                                ...
                                                <ul class="wsus__single_pro_icon">
                                                    <li><a href="#" data-bs-toggle="modal" class="centerStuff" data-bs-target="#exampleModal-{{$product->id}}"><i
                                                                class="far fa-eye"></i></a></li>
                                                    <li><a href="#" class="centerStuff" ><i class="far fa-heart"></i></a></li>
                                                    <li><a href="#" class="centerStuff" ><i class="far fa-random"></i></a>
                                                </ul>
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name" href="{{route('product-detail', $product->slug)}}">{{limitText($product->name, 40)}}</a>
                                                    @if(checkDiscount($product))
                                            ...
                                            <div class="wsus__product_item wsus__list_view">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    @else
                                                        <p class="wsus__price">{{$product->price}}{{$settings->currency_icon}}</p>
                                                    @endif
                                                    <p class="list_description">{{$product->short_desc}}</p>
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form ajax-form" action="{{ route('add-to-cart') }}" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="product_id" value={{$product->id}}>
                                                            ...
                                                            @endforeach
                                                            <input type="hidden" min="1" max="100" value="1" name="qty"/>
                                                            <button class="add_cart_two add_cart" href="#" type="submit" style="margin: 0 10px 0 0">Add to cart</button>
                                                        </form>
                                                        <li><a href="#" style="padding: 12px 0 0 0!important"><i class="far fa-heart"></i></a></li>
                                                        <li><a href="#" style="padding: 12px 0 0 0!important"><i class="far fa-random"></i></a>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                    <div class="wsus__pro_details_text">
                                        ...
                                        <h4>
                                            @if(checkDiscount($product))
                                                {{$product->offer_price}}{{$settings->currency_icon}} <del>{{$product->price}}{{$settings->currency_icon}}</del>
                                            @else
